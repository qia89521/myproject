#pragma checksum "E:\资料\私人项目\2020_08\code\YiShaAdmin-master\YiSha.Web\YiSha.Admin.Web\Areas\OrderManage\Views\OrderMoneyReceipt\OrderMoneyReceiptIndex.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "50985443a2b772072c50aa19b6d4d302510bc752"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"50985443a2b772072c50aa19b6d4d302510bc752", @"/Areas/OrderManage/Views/OrderMoneyReceipt/OrderMoneyReceiptIndex.cshtml")]
...
#nullable disable
        ...
        $('#gridTable').ysTable({
            ...
            WriteLiteral(@"nter',
                    formatter: function (value, row, index) {
                        var actions = [];
                        actions.push(""<a class=\""btn btn-success btn-xs\"" href=\""#\"" onclick=\""printForm('"" + row.PrintOrderNumber + ""')\"" ><i class=\""fa fa-remove\""></i>打印</a>"");
                        return actions.join('');
                    }
                }
            ],
