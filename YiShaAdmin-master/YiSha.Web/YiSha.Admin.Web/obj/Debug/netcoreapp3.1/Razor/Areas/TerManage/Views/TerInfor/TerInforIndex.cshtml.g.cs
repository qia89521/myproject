#pragma checksum "E:\资料\私人项目\2020_08\code\YiShaAdmin-master\YiSha.Web\YiSha.Admin.Web\Areas\TerManage\Views\TerInfor\TerInforIndex.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9fff53fe683c79bfe905748ed90b088c41abd0e4"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9fff53fe683c79bfe905748ed90b088c41abd0e4", @"/Areas/TerManage/Views/TerInfor/TerInforIndex.cshtml")]
...
#nullable disable
            ...
            WriteLiteral(@"
                    ...
                    },
                    {
                        ...
                        formatter: function (value, row, index) {
                            return ""<span title=\""查看转让数据\"" onclick=\""showZhuanRangData('"" + row.Id+""')\"">"" + value + "" <button type=\""button\"" class=\""btn btn-primary btn-xs\"" onclick=\""setManage('"" + row[""Id""] + ""')\"">设 置</button></span>"";
                        }
                    },
                    {
                    ...
                    {
        ");
            WriteLiteral(@"                field: 'BusyLink', title: '联系方式',
                        editable: {
                            type: 'text',
                            emptytext: ""【联系方式】为空"",
                            validate: function (value) {
            ...
            WriteLiteral(@"Buy', title: '是否出货',
                    ...
                    { field: 'BaseCreatorTxt', ti");
            WriteLiteral(@"tle: '创建人' },
                    {
    ...
    function onEditableSave(field, row, oldValue, $el) {
        ...
        var url = '';
        var data = { id: row[""Id""], value: row[fi");
            WriteLiteral("eld] };\r\n        if (field == \"TerName\") {\r\n            url = \'");
#nullable restore
        ...
        if (ys.checkRowDelete(selectedRow)) {
            ys.confirm('确认要删除选中的' + selectedRow.length + '条数据吗？', function () {
                ...
                ys.ajax({
                    url: '");
#nullable restore
#line 303 "E:\资料\私人项目\2020_08\code\YiShaAdmin-master\YiSha.Web\YiSha.Admin.Web\Areas\TerManage\Views\TerInfor\TerInforIndex.cshtml"
